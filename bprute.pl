...
print color('bold red'),"]";
print color('bold white')," OpenCart (belum tersedia bre) \n";
print color('bold red')," [";
...
print color('bold green'),"+";
print color('bold red'),"]";
print color('bold white')," Pilih nomernya berapa : ";
...
if($number eq '1')
{
    open (THETARGET, "<$list") || die "[-] Opps.. tidak bisa membuka file";
@TARGETS = <THETARGET>;
close THETARGET;
$link=$#TARGETS + 1;
...
print color('bold green'),"+";
print color('bold red'),"] ";
print color('bold white'),"Tidak bisa mengambil Username\n";
}
}
